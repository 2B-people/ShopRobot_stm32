...
GPIO_TypeDef*  ENCODER_PORT[ENCODERn] = {RIKI_ENCODER1_GPIO_PORT, RIKI_ENCODER2_GPIO_PORT,RIKI_ENCODER3_GPIO_PORT,RIKI_ENCODER4_GPIO_PORT};
TIM_TypeDef*   ENCODER_TIM[ENCODERn] = {RIKI_ENCODER1_TIM, RIKI_ENCODER2_TIM, RIKI_ENCODER3_TIM, RIKI_ENCODER4_TIM};
const uint16_t ENCODER_A_PIN[ENCODERn] = {RIKI_ENCODER1_A_PIN, RIKI_ENCODER2_A_PIN, RIKI_ENCODER3_A_PIN, RIKI_ENCODER4_A_PIN};
const uint16_t ENCODER_B_PIN[ENCODERn] = {RIKI_ENCODER1_B_PIN, RIKI_ENCODER2_B_PIN, RIKI_ENCODER3_B_PIN, RIKI_ENCODER4_B_PIN};
const uint32_t ENCODER_PORT_CLK[ENCODERn] = {RIKI_ENCODER1_GPIO_CLK, RIKI_ENCODER2_GPIO_CLK, RIKI_ENCODER3_GPIO_CLK, RIKI_ENCODER4_GPIO_CLK};
const uint32_t ENCODER_TIM_CLK[ENCODERn] = {RIKI_ENCODER1_TIM_CLK, RIKI_ENCODER2_TIM_CLK, RIKI_ENCODER3_TIM_CLK, RIKI_ENCODER4_TIM_CLK};
