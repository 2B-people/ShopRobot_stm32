...
PID motor1_pid(-1000, 1000, K_P, K_I, K_D);
PID motor2_pid(-1000, 1000, K_P, K_I, K_D);
PID motor3_pid(-1000, 1000, K_P, K_I, K_D);
PID motor4_pid(-1000, 1000, K_P, K_I, K_D);

Motor motor1(MOTOR1, 1999, 49);
Motor motor2(MOTOR2, 1999, 49);
Motor motor3(MOTOR3, 1999, 49);
Motor motor4(MOTOR4, 1999, 49);
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	while(1)
	{
		...
		{
			usart.print("rpm1 ");usart.putnum(motor1.rpm,6);usart.print("\n");
			usart.print("rpm2 ");usart.putnum(motor2.rpm,6);usart.print("\n");
			usart.print("rpm3 ");usart.putnum(motor3.rpm,6);usart.print("\n");
			usart.print("rpm4 ");usart.putnum(motor4.rpm,6);usart.print("\n");
			...
			usart.print("req1 ");usart.putnum((int)required_rpm.motor1,6);usart.print("\n");
			usart.print("req2 ");usart.putnum((int)required_rpm.motor2,6);usart.print("\n");
			usart.print("req3 ");usart.putnum((int)required_rpm.motor3,6);usart.print("\n");
			usart.print("req4 ");usart.putnum((int)required_rpm.motor4,6);usart.print("\n");usart.print("\n");
