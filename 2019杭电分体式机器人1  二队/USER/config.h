...
/** motor param **/
#define MAX_RPM 8500      //motor's maximum RPM最大转速
#define COUNTS_PER_REV 36 //wheel encoder's no of ticks per rev(gear_ratio * pulse_per_rev)减速比
...
#define BEEP_CLK          RCC_APB2Periph_GPIOF
...
#define infrared_PIN4          GPIO_Pin_11
#define infrared_PORT4          GPIOF
#define infrared_CLK4          RCC_APB2Periph_GPIOF


#define infrared_PIN5          GPIO_Pin_0
#define infrared_PORT5          GPIOE
#define infrared_CLK5          RCC_APB2Periph_GPIOE			//infread5:碰撞模块
...
/**key config**/
#define key_PIN1          GPIO_Pin_3		//中
#define key_PIN2          GPIO_Pin_2		//左
#define key_PIN3          GPIO_Pin_6		//下
#define key_PIN4          GPIO_Pin_5		//右
#define key_PIN5          GPIO_Pin_4		//上
#define key_PIN6          GPIO_Pin_13		//独立

#define key_PORT          GPIOE
#define key_CLK         RCC_APB2Periph_GPIOE

#define key6_CLK   				RCC_APB2Periph_GPIOC
