...
#define hK_P 0.55  // P constant
#define hK_I 0 // I constant
#define hK_D 0.02 // D constant
...
#define slow_vel (0.30)		//车子还在运行状态的最低车速
...
#define infrared_CLK5          RCC_APB2Periph_GPIOB			//infread5:碰撞模块
