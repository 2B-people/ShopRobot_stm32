...
void Motor::Set_Speed(uint16_t target_speed)
{
	this->target_speed = target_speed;
}

void Motor::Get_Speed(uint16_t now_speed)
{
	this->now_speed = now_speed;
}

uint16_t Motor::Show_Target_Speed(void)
{
	return target_speed;
}

uint16_t Motor::Show_Now_Speed(void)
{
	return now_speed;
}
